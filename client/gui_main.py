...
class PeerBrainApp(MDApp):
    ...
    def build(self):
        ...
        self.confirm_new_password_field = Builder.load_string(
            confirm_new_password_helper
        )
        ...
        technical_menu_al_users_button = Builder.load_string(
            technical_menu_check_users_button_helper
        )
        technical_menu_generate_keys_button = Builder.load_string(
            technical_menu_generate_keys_button_helper
        )
        technical_menu_back_button = Builder.load_string(
            technical_menu_back_button_helper
        )
    ...
    def log_in(self):
        ...
        try:
            if login(
                self.server_url, self.username_field.text, self.password_field.text
            ):
                self.authenticated = True
